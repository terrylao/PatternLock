...
class ViewController: UIViewController {
    //var delegate: ViewControllerDelegate = DefaultViewControllerDelegate()
...
extension ViewController {
    internal func configuareLockViewWithImages() {
        ...
        let highlightedImage = UIImage(named: "dot_normal_highlighted")!
        ...
        lockView.didDrawPatternPassword = { (lockView, count, password) -> Void in
            ...
            self.delegate?.eventOccured(self, identifier: password!)
            //self.llabel.text = "Got Password: " + password!
            self.unlockPassword = password!
            /*if password == self.unlockPassword {
